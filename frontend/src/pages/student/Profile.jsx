...
const Profile = () => {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-10 text-left">
      <h1 className="text-2xl sm:text-3xl font-black text-slate-800 tracking-tight mb-8">My Profile</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describe your learning trajectory or background..."
              rows="3"
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. React, Node.js, Git, HTML"
              className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-indigo-500 focus:bg-white transition"
            />
          </div>
